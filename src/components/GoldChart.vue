  ...
  <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 mt-6 animate-slide-down">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
      ...
      <button @click="refreshData" :disabled="isLoading"
        ...
        <svg :class="{ 'animate-spin': isLoading }" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <div class="relative w-full h-87.5">
      ...
      <div v-else-if="error"
        class="absolute inset-0 z-10 flex flex-col items-center justify-center bg-rose-50 rounded-xl border border-rose-100">
