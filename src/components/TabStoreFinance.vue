<template>
  <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
    <div
      class="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-slate-100 flex flex-col justify-center relative overflow-hidden">
      ...
      <div class="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-slate-100">
        ...
        <form @submit.prevent="submitForm" class="space-y-5">
          <div class="flex rounded-xl overflow-hidden bg-slate-100 p-1">
            <button type="button" @click="formType = 'expense'"
            ...
            <button type="button" @click="formType = 'income'"
              class="flex-1 py-3 text-sm font-semibold rounded-lg transition-all"
          ...
          <div class="space-y-4 pb-4">
            ...
            <div>
              ...
              <input type="number" v-model="formAmount" placeholder="Nhập số tiền..." min="1"
            ...
            <div>
              ...
              <input type="text" v-model="formDescription" placeholder="Ví dụ: Ăn sáng, Đổ xăng..."
                class="w-full px-4 py-3 bg-slate-50 rounded-xl border border-slate-200 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors"
                required />
            </div>
          </div>
            ...
            <li v-for="transaction in sortedTransactions" :key="transaction.id"
              ...
              <div class="flex items-center gap-4 sm:gap-5">
                <div class="w-12 h-12 rounded-2xl flex items-center justify-center shrink-0"
                  ...
                  <svg v-if="transaction.type === 'income'" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
              ...
              <div class="flex items-center gap-4">
                <span class="font-bold text-base sm:text-lg whitespace-nowrap"
